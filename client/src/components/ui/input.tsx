...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
	({ className, type, startIcon, ...props }, ref) => {
		return (
			<div className="flex items-center h-10 w-full rounded-md border border-input bg-transparent px-4 py-1 text-base focus-within:ring-1 focus-within:ring-ring disabled:cursor-not-allowed disabled:opacity-50 md:text-xs">
